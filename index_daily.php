...
<html lang="ru">
	...
	<body>
		...
		<form id="form" method="post" action="stats_by_day.php" >
			<div id="agent" class=" w3-container w3-teal w3-border calendar" ><b>Сотрудник:</b>
			<?php
			...
			<div class="w3-cell-row w3-teal w3-border w3-cell-middle calendar">
				<div class="w3-cell "  style="width:10%"><p><b>С:</b></p></div>
				<div class="w3-cell "  style="width:25%"><p><b>День:</b></p>
					<div id="day"> 	
						<select name="day" id="day" class="cal_block">
				...
				<div class="w3-cell" style="width:50%"><p><b>Месяц:</b></p>
					<div id="month_fr"><p> 	
						<select name="month_from" id="mfr" class="cal_block" >
				...
				<div class="w3-cell" style="width:25%"><p><b>Год: </b></p>
					<select name="year_from" id="yfr" class="cal_block" >
						<option value=""> - </option>
			...
			<div class="w3-cell-row w3-teal w3-border w3-cell-middle calendar">
			<div class="w3-cell"  style="width:10%"><p><b>ПО:</b></p></div>
				<div class="w3-cell" style="width:25%"><p><b>День:</b></p>
					<div id="day" > 	
						<select name="day_to" id="day_to" class="cal_block">
							<option value="01">1</option>
							<option value="02">2</option>
							<option value="03">3</option>
							<option value="04">4</option>
				...
				<div class="w3-cell" style="width:50%"><p><b>Месяц:</b></p>
						<div id="month_to" >
							<select name="month_to" id="mto" class="cal_block" >
								<option value="1">Январь</option>
								<option value="2">Февраль</option>
								<option value="3">Март</option>
								<option value="4">Апрель</option>
				...
				<div class="w3-cell">
						<div class="w3-cell" style="width:25%"><p><b>Год:</b></p>
							<select name="year_to" id="yto" class="cal_block" >
								<option value=""> - </option>
								<option value="2016">2016</option>
								<option value="2017">2017</option>
			...
			<b><button input type="submit" name="send" class="send w3-button w3-teal" value="" style="width:100%">ВВОД</button></b>
	
			</form>
		</div>
		<script>
		$('form').submit(function(event){
			var month_from=parseInt($("#mfr").val());
			var month_to=parseInt($("#mto").val());
			var year_cond =($("#yto").val()<$("#yfr").val());
			var year_cond_eq =($("#yto").val()==$("#yfr").val());
			var month_cond =(month_from>month_to);
